...
using MalamuleleHealth.Models.TokenAuth;
...
{
    public abstract class MalamuleleHealthWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MalamuleleHealthWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MalamuleleHealthWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MalamuleleHealthDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MalamuleleHealthDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MalamuleleHealthDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MalamuleleHealthDbContext, Task<T>> func)
        {
            T result;
